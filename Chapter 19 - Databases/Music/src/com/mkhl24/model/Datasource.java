...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/mkhl24/Рабочий стол/JavaPrograms/Chapter 19 - Databases/Music/" + DB_NAME;
    ...
    public static final int INDEX_SONG_NAME = 4;

    public static final int ORDER_BY_NON = 1;
    public static final int ORDER_BY_ASC = 2;
    public static final int ORDER_BY_DESC = 3;

    public static final String QERY_ALBUMS_BY_ARTIST_START =
    ...
    private PreparedStatement querySongFromView;
    ...
    public boolean open() {
        try {
            ...
            querySongFromView = conn.prepareStatement(QUERY_VIEW_SONG_INFO_PREP);
    ...
    public void close() {
        try {
            if (querySongFromView != null) {
                querySongFromView.close();
            }
            ...
            System.out.println("Couldn't close connection to DB " + e.getMessage());
            e.printStackTrace();
        }
    }
...
//            }
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        StringBuilder sb = new StringBuilder(QERY_ALBUMS_BY_ARTIST_START);
...
//            int min = results.getInt("min_id");
    ...
    public List<SongArtist> querySongInfoView(String title) {
        ...
        try {
            querySongFromView.setString(1, title);
            ResultSet results = querySongFromView.executeQuery();
